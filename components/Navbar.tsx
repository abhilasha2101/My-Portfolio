  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-[#131314]/90 backdrop-blur-md border-b border-[#c5a059]/20 shadow-lg"
          : "bg-transparent border-b border-transparent"
      }`}
      style={{
        backgroundColor: scrolled ? "rgba(19, 19, 20, 0.92)" : "transparent",
      }}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <div className="flex flex-col">
            <span className="font-label text-[10px] sm:text-[11px] uppercase tracking-[0.22em] sm:tracking-[0.24em] font-semibold text-[#e5e2e3]">
              ABHILASHA KUMARI
            </span>
        ...
        <div className="hidden md:flex items-center gap-4 lg:gap-6">
          <nav className="flex items-center gap-1 bg-[#1c1b1c]/80 px-2 py-1 rounded-full border border-[#c5a059]/20 backdrop-blur-sm">
            {NAV_ITEMS.map((item) => {
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full font-label text-[10px] uppercase tracking-[0.16em] transition-all duration-200 cursor-pointer ${
                    isActive
                      ...
                      : "text-[#d1c5b4] hover:text-[#e9c176] hover:bg-[#2a2a2b]/60"
                  }`}
                >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-[#131314]/98 border-b border-[#c5a059]/30 px-5 py-4 backdrop-blur-2xl overflow-hidden shadow-2xl"
          >
                  ...
                  <button
                    ...
                    className={`text-left py-3 px-3.5 rounded-lg font-label text-xs uppercase tracking-widest flex items-center justify-between transition-all cursor-pointer min-h-[44px] ${
                      isActive
                        ...
                        : "text-[#e5e2e3] hover:bg-[#c5a059]/15"
                    }`}
                  >
