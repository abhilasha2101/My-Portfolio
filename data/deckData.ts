...
export const HERO_PERSONAS: HeroPersona[] = [
  ...
  },
  {
    ...
    tags: ["Node.js", "Java", "Spring Boot", "Databases"],
  ...
  },
  {
    ...
    rank: "Q",
    suit: "♦",
    suitName: "AI & INTELLIGENCE",
    isRed: true,
    name: "AI & Machine Learning",
    role: "Applied AI & Automation",
    tags: ["AI Agents", "Prompt Workflows", "Python / FastAPI"],
    edition: "SPECIALIZATION 03 • AI SYSTEMS",
    bio: "Developing practical AI applications, autonomous agent workflows, and intelligent data interfaces.",
  },
  {
    idx: 3,
    rank: "10",
...
export const MAIN_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    subtitle: "Real-Time News Verification & AI Telemetry",
    description:
      "AI-powered verification platform verifying claims, facts, and live news streams with probabilistic truth scoring.",
    detailedDescription:
      "An AI-focused project exploring practical applications of artificial intelligence, automated reasoning, and cognitive processing. Features responsive conversational interfaces, prompt management, and modern React/Next.js frontend integration.",
    technologies: ["React", "Next.js", "AI Core", "Python / FastAPI", "Tailwind CSS"],
  ...
  },
  {
    ...
    subtitle: "Civic Intelligence & Geo-Spatial Platform",
    description:
      "Civic intelligence and spatial data platform presented to the Chief Minister of Delhi. Built with interactive mapping and real-time public datasets.",
    detailedDescription:
      "A civic intelligence platform synthesizing spatial datasets, municipal public data, and community metrics. Developed with React, Vite, and FastAPI for real-time data visualization and civic accountability. Includes interactive geographical heatmaps and automated anomaly detection.",
...
export const MORE_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    subtitle: "AI Workflow & Pipeline Composer",
    description:
      "AI workflow-building project designed to orchestrate asynchronous agent chains and structured prompt pipelines.",
    detailedDescription:
      "An AI workflow-building project designed to orchestrate asynchronous agent chains, structured prompt pipelines, and multi-step tool invocations for reproducible AI task execution.",
    technologies: ["Agent Orchestration", "Pipelines", "TypeScript", "Node.js"],
    githubUrl: "https://github.com/abhilasha2101/AI-agent-workflow-builder",
    statusText: "OPEN SOURCE REPOSITORY",
...
export const ACHIEVEMENTS: Achievement[] = [
  {
    ...
    supportingDetail:
      "Presented Aakar civic intelligence project to the Chief Minister of Delhi and was selected for a 3-day government bootcamp in Delhi.",
    reverseTitle: "Selected for 3-Day Government Bootcamp in Delhi",
    reverseBody:
      "Presented the Aakar civic intelligence and spatial data platform to the Chief Minister of Delhi at the regional innovation forum. Evaluated on civic utility, spatial algorithmic processing, and actionable public dashboard design.",
    attributes: [
